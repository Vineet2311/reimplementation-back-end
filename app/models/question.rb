class Question < ApplicationRecord
    ...
    #   question_ids = []
    #   questionnaires = Assignment.find(assignment_id).questionnaires.select { |questionnaire| questionnaire.question_type == 'ReviewQuestionnaire' }
    ...
    #   fields = ['Seq', 'Question', 'Question Type', 'Weight', 'text area size', 'max_label', 'min_label']
    #   fields
    # end
